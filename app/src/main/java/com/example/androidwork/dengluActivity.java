...
import com.example.androidwork.bean.UserInfo;
import com.example.androidwork.database.UserDBHelper;
import com.example.androidwork.util.ViewUtil;

public class dengluActivity extends AppCompatActivity implements  View.OnClickListener,View.OnFocusChangeListener, OnCheckedChangeListener {
    ...
    private Button btn_logon; // 声明一个登注册按钮控件对象
